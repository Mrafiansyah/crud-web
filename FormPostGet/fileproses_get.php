...
<body>
  ...
  <header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-lg">
    <div class="container-fluid d-flex align-items-center">
      <h1 class="d-flex align-items-center fs-4 text-white mb-0">
        <img src="nelayan.png" width="50" height="30" class="me-3" alt="">
        Form Identitas
      </h1>
  ...
  <div id="form2">
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          ...
          <p>
            <a href="index_get.php" class="btn btn-primary my-2">Menu</a>
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top bg-dark">
      <p class="col-md-4 mb-0 text-muted">&copy; Muhammad Rafiansyah</p>

      <a href="/" class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
        <img src="nelayan.png" width="40" height="32"></a>
      </a>

      <ul class="nav col-md-4 justify-content-end">
        <li class="nav-item"><a href="index_get.php" class="nav-link px-2 text-muted">Kembali</a></li>
