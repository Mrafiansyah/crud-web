...
<body>
  <form action="fileproses_get.php" method="GET">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top bg-dark ">
    <p class="col-md-4 mb-0 text-light ">&copy; Muhammad Rafiansyah</p>
    ...
    <ul class="nav col-md-4 justify-content-end">
      <li class="nav-item"><a href="fileproses_get.php" class="nav-link px-8 text-light bold">Form</a></li>
